...
const IncomeCard = () => {
	return (
		<div class="flex-1 ml-7 p-4 bg-white rounded-2xl shadow-xl">
			<div class="flex items-center border-b-2 mb-3 pb-2 text-xs">
				<div>
					<svg
						width="5"
						height="5"
					...
					>
						<circle cx="4" cy="4" r="4" fill="#0166FF"></circle>
					</svg>
				</div>
				<p class="ml-1 lg:text-base">Total Expenses</p>
			</div>
			<div>
				<span class="font-bold lg:text-4xl md:text-2xl text-xl text-red-400">
					-95,000₮
				</span>
				<p class="text-xs lg:text-base lg:my-4 md:my-3 my-2 text-slate-500">
					Your Expense Amount
				</p>
				<div class="flex items-center ">
					...
					<span class="ml-1 lg:text-base text-xs">32% from last month</span>
				</div>
			</div>
		</div>
	);
