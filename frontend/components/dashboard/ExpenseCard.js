		...
		<div class="flex-1 ml-7 p-4 bg-white rounded-2xl shadow-xl">
			<div class="flex items-center border-b-2 mb-3 pb-2 text-xs">
				<div>
					...
					>
						<circle cx="4" cy="4" r="4" fill="#84CC16"></circle>
					</svg>
				</div>
				<p class="ml-1 lg:text-base">Your Income</p>
			</div>
			<div>
				<span class="font-bold lg:text-4xl md:text-2xl text-xl text-green-500">
					30,000₮
				</span>
				<p class="text-xs my-2 lg:text-base md:my-3 lg:my-4 text-slate-500">
					Your Income Amount
				</p>
