...
export default function RecordSmall() {
	...
	return (
		<div>
			...
			<div className="align-items flex mb-5">
				<button
					onClick={() => {
						setOpen(true);
					}}
					className="bg-[#0166ff] flex flex-row justify-center pt-1 gap-1 w-full cursor-pointer font-sans  rounded-[20px] text-white p-1 items-center"
				>
					<svg
						width="16"
						height="16"
